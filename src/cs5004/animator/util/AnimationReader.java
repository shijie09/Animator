...
public class AnimationReader {
   ...
   * @param <ProcessInterface> The main model interface type describing animations
   * @return the builder.
   */
  public static <ProcessInterface> ProcessInterface parseFile(Readable readable,
  ...
  private static <ProcessInterface> void readCanvas(Scanner s,
      AnimationBuilder<ProcessInterface> builder) {
    int[] vals = new int[4];
  ...
  private static <ProcessInterface> void readShape(Scanner s,
      AnimationBuilder<ProcessInterface> builder) {
    String name;
    String type;
    if (s.hasNext()) {
  ...
  private static <ProcessInterface> void readMotion(Scanner s,
      AnimationBuilder<ProcessInterface> builder) {
